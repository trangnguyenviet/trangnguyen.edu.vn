...
TVUB.Home = function (game) {
    ...
    this.initState.prototype = {
        create: function () {
            ...
            /////////////
            this.trauvang = _game.createObject.apply(this, [[
                {
                    image: 'trau_chien_thang_tayphai',
                    animation: true
                }, {
                    image: 'trau_chien_thang_taytrai',
                    animation: true
                }, {
                    image: 'trau_chien_thang_than',
                    animation: false
                }, {
                    image: 'trau_chien_thang_dau',
                    animation: true
                }
            ]]);
            this.trauvang.x = 0;
            this.trauvang.y = _game.hh - 30;
            this.game.add.tween(this.trauvang).to({y: _game.hh + 10}, 400, Phaser.Easing.Back.Out, true);
